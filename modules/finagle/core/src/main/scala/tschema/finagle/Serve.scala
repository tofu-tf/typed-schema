...
import tschema.finagle.Rejection.missingParam
import tschema.param.ParamSource.{All, Query}
import tschema.param._
import tschema.typeDSL.{Delete, Get, Head, Options, Post, Put, QueryParams}
import tschema.utils.cont
import shapeless._
...
private[finagle] trait ServeReqBodyInstances extends ServeReqBodyInstances1 { self: Serve.type =>
  import tschema.typeDSL.ReqBody
